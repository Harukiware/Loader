...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string HWIDLIST = wb.DownloadString("https://github.com/Harukiware/Loader/blob/master/hwid.txt"); //Replace "HWID List URL" with your own URL to a RAW text (txt) file with all your wanted HWIDs [Example: http://myurl.com/HWID.txt]
            ...
            {
                string mainpath = "C:\\Windows\\onetap.dll"; //You can change the path to wherever you want but just remember to use "\\" instead of just one "\"
                wb.DownloadFile("https://github.com/Harukiware/Loader/raw/master/onetap.dll", mainpath); //Replace "DLL URL" with the URL to directly download your DLL [Example: http://myurl.com/MYDLL.dll]
        ...
        {
            System.Diagnostics.Process.Start("https://discord.gg/6z7fQ8Z");
        }
        ...
        {
            System.Diagnostics.Process.Start("https://youtu.be/fC7oUOUEEi4");
        }
        ...
        {
            System.Diagnostics.Process.Start("https://www.onetap.com/");
        }
